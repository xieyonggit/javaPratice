package multiThread.atomicBoolean;
...
public class T {
    ...
    AtomicBoolean running=  new AtomicBoolean(true);   // 对比有无volatile的情况下，整个程序运行结果的区别
//    /*volatile*/ boolean running=true;
    void m() {
        System.out.println(" m start ");
        while (running.get()) { // 直到主线程将running设置为false，T线程才会退出
